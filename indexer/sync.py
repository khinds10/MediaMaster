...
for file in allFiles:
    ...
    for original in originalFile:
        fileId_original,fullPath_original,directoryName_original,baseName_original,ext_original,fileName_original,mimeType_original,size_original,dateAccessed_original,dateModified_original,width_original,height_original,directoryId_original = original
